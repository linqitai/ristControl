...
export default {
  ...
  methods: {
    ...
    promoteMoneyTotal() {
      ...
      Indicator.open();
      axios
        .post(root + "/promoteQuota/query", params, config)
        .then(res => {
          Indicator.close();
          this.code = res.data.code;
          this.asset =
            res.data.data.asset === undefined ? -1 : res.data.data.asset;
          // 资产与经营
          ...
          // 客流状态判断
          this.peopleMoney =
            res.data.data.passenger === undefined ? 0 : res.data.data.passenger;
          //            this.peopleMoney = (res.data.data.hasOwnProperty(passenger))
          //            this.fallFootDate = res.data.data.fallFootDate
          this.fallFootDate =
            res.data.data.fallFootDate === undefined
              ? -1
              : res.data.data.fallFootDate;
          ...
          //安保服务
          this.securityMoney =
            res.data.data.security === undefined ? 0 : res.data.data.security;
          this.openDoorDate =
            res.data.data.openDoorDate === undefined
              ? -1
              : res.data.data.openDoorDate;
    ...
    peopleClick() {
      ...
      axios
        .post(root + "/promoteQuota/fallFootPro", params, config)
        .then(res => {
          this.code = res.data.code;
          ...
          if (this.aa == true) {
            ...
            if (this.code === 1000) {
              this.peopleMoney =
                res.data.data.passenger === undefined
                  ? 0
                  : res.data.data.passenger;
    ...
    peopleStatist() {
      if (this.peopleApplyShow == true) {
        var asd = JSON.stringify({
          stageproductId: "2",
          atborrowMoney: this.atborrowMoney
        });
    ...
    servicesClick() {
      ...
      axios
        .post(root + "/promoteQuota/securityPro", params, config)
        .then(res => {
          this.code = res.data.code;
          this.msg = res.data.msg;
          if (this.bb == true) {
            ...
            if (this.code === 1000) {
              this.securityMoney =
                res.data.data.security === undefined
                  ? 0
                  : res.data.data.security;
              this.openRateScore =
                res.data.data.openRateScore === undefined
                  ? 0
                  : res.data.data.openRateScore;
              if (this.securityMoney > 0) {
                this.money = this.money + this.securityMoney;
              }
